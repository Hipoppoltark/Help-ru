...
<html>
  <head>
    ...
    <link rel="stylesheet" href="?__debugger__=yes&amp;cmd=api&amp;f=style.css"
        type="text/css">
    <!-- We need to make sure this has a favicon so that the debugger does
         not by accident trigger a request to /favicon.ico which might
         change the application state. -->
    <link rel="shortcut icon"
        href="?__debugger__=yes&amp;cmd=api&amp;f=console.png">
    <script src="?__debugger__=yes&amp;cmd=api&amp;f=jquery.js"></script>
    <script src="?__debugger__=yes&amp;cmd=api&amp;f=debugger.js"></script>
