...
class Unauthorized(HTTPException):
    ...
    Raise if the user is not authorized to access a api.
...
class Forbidden(HTTPException):
    ...
    Raise if the user doesn't have the permission for the requested api
    ...
    description = (
        ...
        " api. It is either read-protected or not readable by the"
        " server."
    )
...
class NotFound(HTTPException):
    ...
    Raise if a api does not exist and never existed.
    """
...
class MethodNotAllowed(HTTPException):
    ...
    Raise if the server used a method the api does not handle.  For
    example `POST` if the api is view only.  Especially useful for REST.
...
class NotAcceptable(HTTPException):
    ...
    description = (
        "The api identified by the request is only capable of"
...
class Conflict(HTTPException):
    ...
    description = (
        ...
        " api might have been modified while the request was being"
        " processed."
    )
...
class Gone(HTTPException):
    ...
    Raise if a api existed previously and went away without new location.
    """
...
class Locked(HTTPException):
    ...
    Used if the api that is being accessed is locked.
    """

    code = 423
    description = "The api that is being accessed is locked."


class FailedDependency(HTTPException):
    """*424* `Failed Dependency`

    Used if the method could not be performed on the api
    because the requested action depended on another action and that action failed.
    """

    code = 424
    description = (
        "The method could not be performed on the api because the"
...
class PreconditionRequired(HTTPException):
    ...
    clients attempting to update a api through PUT or DELETE. By requiring
...
class UnavailableForLegalReasons(HTTPException):
    ...
    api as a consequence of a legal demand.
    """
