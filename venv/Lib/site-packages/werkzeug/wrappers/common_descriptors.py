...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property(
        ...
        api from which the Request-URI was obtained (the
...
class CommonResponseDescriptorsMixin(object):
    ...
    content_location = header_property(
        ...
        supply the api location for the entity enclosed in the
        message when that entity is accessible from a location separate
        from the requested api's URI.""",
    )
    ...
    allow = _set_property(
        ...
        supported by the api identified by the Request-URI. The
        purpose of this field is strictly to inform the recipient of
        valid methods associated with the api. An Allow header
