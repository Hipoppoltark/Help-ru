...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'landing.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/landing.html'`` the file from the app1 package is loaded,
    by loading ``'app2/landing.html'`` the file from the second.
    """
